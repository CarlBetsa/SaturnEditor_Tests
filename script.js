...
function setupDragAndDrop() {
    ...
    function renderFileList() {
        ...
        async function loadPartnerFolders() {
            try {
                const response = await fetch('https://carlbetsa.github.io/SaturnEditor_Tests/Sons_da_Comunidade/folderList.json');
        ...
        async function loadPartnerFiles(folderName, targetList) {
            try {
                const response = await fetch(`https://carlbetsa.github.io/SaturnEditor_Tests/Sons_da_Comunidade/${folderName}/fileList.json`);
                const fileNames = await response.json();
                ...
                const filesData = await Promise.all(
                    fileNames.map(async (fileName) => {
                        try {
                            const res = await fetch(`https://carlbetsa.github.io/SaturnEditor_Tests/Sons_da_Comunidade/${folderName}/${fileName}`);
